    ...
    public partial class initss : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientHestory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientHestory_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drug_Hospital_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospital",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Drug_DrugId",
                        column: x => x.DrugId,
                        principalTable: "Drug",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestLabs_PatientHestory_PatientHestoryId",
                        column: x => x.PatientHestoryId,
                        principalTable: "PatientHestory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drug_HospitalId",
                table: "Drug",
                column: "HospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_Drug_OrderItemId",
                table: "Drug",
                column: "OrderItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientHestory_UserId",
                table: "PatientHestory",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Drug_OrderItems_OrderItemId",
                table: "Drug",
                column: "OrderItemId",
                principalTable: "OrderItems",
                principalColumn: "Id");
